...
public enum EmojiDisplayRules {
    ...
    1.value不能从0开始，因为0会被库自动设置为删除按钮
    2.type:0 emoji表情，1 GITHUB表情 2 自然表情
     */
    EMOJI0(0, 1, R.drawable.smiley_0, "[微笑]", "[0]"), EMOJI1(0, 1,
            R.drawable.smiley_1, "[撇嘴]", "[1]"), EMOJI2(0, 1,
            R.drawable.smiley_2, "[色]", "[2]"), EMOJI3(0, 1,
            R.drawable.smiley_3, "[发呆]", "[3]"), EMOJI4(0, 1,
            R.drawable.smiley_4, "[得意]", "[4]"), EMOJI5(0, 1,
            R.drawable.smiley_5, "[流泪]", "[5]"), EMOJI6(0, 1,
            R.drawable.smiley_6, "[害羞]", "[6]"), EMOJI7(0, 1,
            R.drawable.smiley_7, "[闭嘴]", "[7]"), EMOJI8(0, 1,
            R.drawable.smiley_8, "[睡]", "[8]"), EMOJI9(0, 1,
            R.drawable.smiley_9, "[大哭]", "[9]"), EMOJI10(0, 1,
            R.drawable.smiley_10, "[尴尬]", "[10]"), EMOJI11(0, 1,
            R.drawable.smiley_11, "[发怒]", "[11]"), EMOJI12(0, 1,
            R.drawable.smiley_12, "调皮", "[12]"), EMOJI13(0, 1,
            R.drawable.smiley_13, "[呲牙]", "[13]"), EMOJI14(0, 1,
            R.drawable.smiley_14, "[惊讶]", "[14]"), EMOJI15(0, 1,
            R.drawable.smiley_15, "[难过]", "[15]"), EMOJI16(0, 1,
            R.drawable.smiley_16, "[酷]", "[16]"), EMOJI17(0, 1,
            R.drawable.smiley_17, "[冷汗]", "[17]"), EMOJI18(0, 1,
            R.drawable.smiley_18, "[抓狂]", "[18]"), EMOJI19(0, 1,
            R.drawable.smiley_19, "[吐]", "[19]"), EMOJI20(0, 1,
            R.drawable.smiley_20, "[偷笑]", "[20]"), EMOJI21(0, 1,
            R.drawable.smiley_21, "[可爱]", "[21]"), EMOJI22(0, 1,
            R.drawable.smiley_22, "[白眼]", "[22]"), EMOJI23(0, 1,
            R.drawable.smiley_23, "[傲慢]", "[23]"), EMOJI24(0, 1,
            R.drawable.smiley_24, "[饥饿]", "[24]"), EMOJI25(0, 1,
            R.drawable.smiley_25, "[困]", "[25]"), EMOJI26(0, 1,
            R.drawable.smiley_26, "[惊恐]", "[26]"), EMOJI27(0, 1,
            R.drawable.smiley_27, "[流汗]", "[27]"), EMOJI28(0, 1,
            R.drawable.smiley_28, "[憨笑]", "[28]"), EMOJI29(0, 1,
            R.drawable.smiley_29, "[大兵]", "[29]"), EMOJI30(0, 1,
            R.drawable.smiley_30, "[奋斗]", "[30]"), EMOJI31(0, 1,
            R.drawable.smiley_31, "[咒骂]", "[31]"), EMOJI32(0, 1,
            R.drawable.smiley_32, "[疑问]", "[32]"), EMOJI33(0, 1,
            R.drawable.smiley_33, "[嘘]", "[33]"), EMOJI34(0, 1,
            R.drawable.smiley_34, "[晕]", "[34]"), EMOJI35(0, 1,
            R.drawable.smiley_35, "折磨", "[35]"), EMOJI36(0, 1,
            R.drawable.smiley_36, "衰", "[36]"), EMOJI37(0, 1,
            R.drawable.smiley_37, "骷髅", "[37]"), EMOJI38(0, 1,
            R.drawable.smiley_38, "敲打", "[38]"), EMOJI39(0, 1,
            R.drawable.smiley_39, "再见", "[39]"), EMOJI40(0, 1,
            R.drawable.smiley_40, "擦汗", "[40]"), EMOJI41(0, 1,
            R.drawable.smiley_41, "抠鼻", "[41]"), EMOJI42(0, 1,
            R.drawable.smiley_42, "鼓掌", "[42]"), EMOJI43(0, 1,
            R.drawable.smiley_43, "糗大了", "[43]"), EMOJI44(0, 1,
            R.drawable.smiley_44, "坏笑", "[44]"), EMOJI45(0, 1,
            R.drawable.smiley_45, "[左哼哼]", "[45]"), EMOJI46(0, 1,
            R.drawable.smiley_46, "[右哼哼]", "[46]"), EMOJI47(0, 1,
            R.drawable.smiley_47, "[哈欠]", "[47]"), EMOJI48(0, 1,
            R.drawable.smiley_48, "[鄙视]", "[48]"), EMOJI49(0, 1,
            R.drawable.smiley_49, "[委屈]", "[49]"), EMOJI50(0, 1,
            R.drawable.smiley_50, "[快哭了]", "[50]"), EMOJI51(0, 1,
            R.drawable.smiley_51, "[阴险]", "[51]"), EMOJI52(0, 1,
            R.drawable.smiley_52, "[亲亲]", "[52]"), EMOJI53(0, 1,
            R.drawable.smiley_53, "[吓]", "[53]"), EMOJI54(0, 1,
            R.drawable.smiley_54, "[可怜]", "[54]"), EMOJI55(0, 1,
            R.drawable.smiley_55, "[菜刀]", "[55]"), EMOJI56(0, 1,
            R.drawable.smiley_56, "[西瓜]", "[56]"), EMOJI57(0, 1,
            R.drawable.smiley_57, "[啤酒]", "[57]"), EMOJI58(0, 1,
            R.drawable.smiley_58, "[篮球]", "[58]"), EMOJI59(0, 1,
            R.drawable.smiley_59, "[乒乓]", "[59]"), EMOJI60(0, 1,
            R.drawable.smiley_60, "[咖啡]", "[60]"), EMOJI61(0, 1,
            R.drawable.smiley_61, "[饭]", "[61]"), EMOJI62(0, 1,
            R.drawable.smiley_62, "[猪头]", "[62]"), EMOJI63(0, 1,
            R.drawable.smiley_63, "[玫瑰]", "[63]"), EMOJI64(0, 1,
            R.drawable.smiley_64, "[凋谢]", "[64]"), EMOJI65(0, 1,
            R.drawable.smiley_65, "[嘴唇]", "[65]"), EMOJI66(0, 1,
            R.drawable.smiley_66, "[爱心]", "[66]"), EMOJI67(0, 1,
            R.drawable.smiley_67, "[心碎]", "[67]"), EMOJI68(0, 1,
            R.drawable.smiley_68, "[蛋糕]", "[68]"), EMOJI69(0, 1,
            R.drawable.smiley_69, "[闪电]", "[69]"), KJEMOJI70(0, 1,
            R.drawable.smiley_70, "[炸弹]", "[70]"), EMOJI71(0, 1,
            R.drawable.smiley_71, "[刀]", "[71]"), EMOJI72(0, 1,
            R.drawable.smiley_72, "[足球]", "[72]"), EMOJI73(0, 1,
            R.drawable.smiley_73, "[瓢虫]", "[73]"), EMOJI74(0, 1,
            R.drawable.smiley_74, "[便便]", "[74]"), EMOJI75(0, 1,
            R.drawable.smiley_75, "[月亮]", "[75]"), EMOJI76(0, 1,
            R.drawable.smiley_76, "[太阳]", "[76]"), EMOJI77(0, 1,
            R.drawable.smiley_77, "[礼物]", "[77]"), EMOJI78(0, 1,
            R.drawable.smiley_78, "[拥抱]", "[78]"), EMOJI79(0, 1,
            R.drawable.smiley_79, "[强]", "[79]"), EMOJI80(0, 1,
            R.drawable.smiley_80, "[弱]", "[80]"), EMOJI81(0, 1,
            R.drawable.smiley_81, "[握手]", "[81]"), EMOJI82(0, 1,
            R.drawable.smiley_82, "[胜利]", "[82]"), EMOJI83(0, 1,
            R.drawable.smiley_83, "[抱拳]", "[83]"), EMOJI84(0, 1,
            R.drawable.smiley_84, "[勾引]", "[84]"), EMOJI85(0, 1,
            R.drawable.smiley_85, "[拳头]", "[85]"), EMOJI86(0, 1,
            R.drawable.smiley_86, "[差劲]", "[86]"), EMOJI87(0, 1,
            R.drawable.smiley_87, "[爱你]", "[87]"), EMOJI88(0, 1,
            R.drawable.smiley_88, "[NO]", "[88]"), EMOJI89(0, 1,
            R.drawable.smiley_89, "[OK]", "[89]"), EMOJI90(0, 1,
            R.drawable.smiley_90, "[爱情]", "[90]"), EMOJI91(0, 1,
            R.drawable.smiley_91, "[飞吻]", "[91]"), EMOJI92(0, 1,
            R.drawable.smiley_92, "[跳跳]", "[92]"), EMOJI93(0, 1,
            R.drawable.smiley_93, "[发抖]", "[93]"), EMOJI94(0, 1,
            R.drawable.smiley_94, "[怄火]", "[94]"), EMOJI95(0, 1,
            R.drawable.smiley_95, "[转圈]", "[95]"), EMOJI96(0, 1,
            R.drawable.smiley_96, "[磕头]", "[96]"), EMOJI97(0, 1,
            R.drawable.smiley_97, "[回头]", "[97]"), EMOJI98(0, 1,
            R.drawable.smiley_98, "[跳绳]", "[98]"), EMOJI99(0, 1,
            R.drawable.smiley_99, "[投降]", "[99]"), EMOJI100(0, 1,
            R.drawable.smiley_100, "[激动]", "[100]"), EMOJI101(0, 1,
            R.drawable.smiley_101, "[乱舞]", "[101]"), EMOJI102(0, 1,
            R.drawable.smiley_102, "[献吻]", "[102]"), EMOJI103(0, 1,
            R.drawable.smiley_103, "[左太极]", "[103]"), EMOJI104(0, 1,
    ...
    private EmojiDisplayRules(int type, int value, int resId, String emojiStr,
                         String remote) {
        this.type = type;
    ...
    private static EmojiIcon getEmojiFromEnum(EmojiDisplayRules data) {
    ...
    public static EmojiIcon getEmojiFromRes(int resId) {
        for (EmojiDisplayRules data : values()) {
