...
public class PagerSlidingTabStrip extends HorizontalScrollView implements
    ...
    private TSOnPageChangeListener listener;
    ...
    public View getBadgeView(int i) {
        return getTabsLayout().getChildAt(i).findViewById(R.id.tab_mes_tv);
    }
    ...
    public void setOnPagerChange(TSOnPageChangeListener l) {
        this.listener = l;
    }

    public interface TSOnPageChangeListener {
