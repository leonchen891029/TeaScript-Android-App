...
public class BrowserFragment extends BaseFragment{
    ...
    private ImageView mSystemBrowserIV;

    public static final String BROWSER_KEY="browser_key";
    public static final String DEFAULT_URL="http://www.teascript.com/";

    private Activity aty;
    private String mCurrentUrl=DEFAULT_URL;

    private int doubleTAG=1;
    ...
    public void initView(View view) {
        ...
        mWebView=(WebView) view.findViewById(R.id.browser_wv);
        mProgressBar=(ProgressBar) view.findViewById(R.id.browser_pb);
        mBottomLL=(LinearLayout) view.findViewById(R.id.browser_bottom_ll);
        mBackIV=(ImageView) view.findViewById(R.id.browser_back_iv);
        mForwardIV=(ImageView) view.findViewById(R.id.browser_forward_iv);
        mRefreshIV=(ImageView) view.findViewById(R.id.browser_refresh_iv);
        mSystemBrowserIV=(ImageView) view.findViewById(R.id.system_browser_iv);
        ...
        mSystemBrowserIV.setOnClickListener(this);
    ...
    protected void onUrlLoading(WebView view, String url) {
        ...
        cookie.setCookie(url, AppContext.getInstance().getProperty(AppConfig.APP_COOKIE));
    }
    ...
    private class MyGestureListener extends SimpleOnGestureListener {
        ...
        public boolean onDoubleTap(MotionEvent e) {// webview的双击事件
            if (doubleTAG % 2 == 0) {
                doubleTAG++;
                mBottomLL.startAnimation(animBottomIn);
            } else {
                doubleTAG++;
                mBottomLL.startAnimation(animBottomOut);
            }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.browser_back_iv:
                mWebView.goBack();
                break;
            case R.id.browser_forward_iv:
                mWebView.goForward();
                break;
            case R.id.browser_refresh_iv:
                mWebView.loadUrl(mWebView.getUrl());
                break;
            case R.id.system_browser_iv:
                try {
                    // 启用外部浏览器
