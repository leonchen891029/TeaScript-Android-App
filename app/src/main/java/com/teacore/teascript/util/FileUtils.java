...
public class FileUtils {
    ...
    //写文本文件，在android中，文件保存在/data/data/PACKAGE_NAME/files目录下
    ...
    public static boolean deleteDirectory(String dirName) {
        ...
        if (!dirName.equals("")) {
            File path = Environment.getExternalStorageDirectory();
            File newPath = new File(path.toString() + dirName);
    ...
    //获取保存目录
    public static String getSavePath(Context context, String dir) {
