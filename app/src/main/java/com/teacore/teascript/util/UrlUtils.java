...
public class UrlUtils implements Serializable{
    ...
    private final static String URL_TYPE_BLOG = URL_SPLITTER + "blog"
            + URL_SPLITTER;
    private final static String URL_TYPE_Teatime = URL_SPLITTER + "Teatime"
            + URL_SPLITTER;
    ...
    public final static int URL_OBJ_TYPE_Teatime = 0x006;
        ...
        try {
            ...
            if (url.getHost().contains(URL_HOST)) {
                ...
                // my
                    ...
                    // 动弹 my.oschina.net/dong706/Teatime/612947
                    else if (path.contains(URL_TYPE_Teatime)) {
                        objId = parseObjId(path, URL_TYPE_Teatime);
                        urls.setObjId(StringUtils.toInt(objId));
                        urls.setObjType(URL_OBJ_TYPE_Teatime);
                    }
