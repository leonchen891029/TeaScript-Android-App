...
public class News extends Entity{
    ...
    public static final int NEWSTYPE_NEWS=0x00;
    public static final int NEWSTYPE_SOFTWARE=0x01;
    public static final int NEWSTYPE_POST=0x02;
    public static final int NEWSTYPE_BLOG=0x03;
    ...
    public void setNewsType(NewsType newType) {
