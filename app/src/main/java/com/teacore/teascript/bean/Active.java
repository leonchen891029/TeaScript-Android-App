...
public class Active extends Entity{
    ...
    //其他
    public final static int CATALOG_OTHER=0;
    //新闻
    ...
    //博客
    public final static int CATALOG_BLOG = 4;
    ...
    @XStreamAlias("teatimeimage")
    private String teatimeImage;

    @XStreamAlias("teatimeattach")
    private String teatimeAttach;
    ...
    public String getTeatimeAttach() {
        return teatimeAttach;
    }

    public void setTeatimeAttach(String teatimeAttach) {
        this.teatimeAttach = teatimeAttach;
    }

    public String getTeatimeImage() {
        return teatimeImage;
    }

    public void setTeatimeImage(String teatimeImage) {
        this.teatimeImage = teatimeImage;
    }
